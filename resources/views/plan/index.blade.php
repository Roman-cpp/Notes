...
@push('styles')
    <link href="{{mix('/css/light/modal.css')}}" rel="stylesheet" type="text/css">
    <link href="{{mix('/css/dark/modal.css')}}" rel="stylesheet" type="text/css">
    <link href="{{mix('/css/light/scrumboard.css')}}" rel="stylesheet" type="text/css">
    <link href="{{mix('/css/dark/scrumboard.css')}}" rel="stylesheet" type="text/css">
@endpush

@push('script')
    <script src="{{mix('js/jquery-ui.min.js')}}"></script>
    <script src="{{mix('js/scrumboard.js')}}"></script>
@endpush
                            ...
                            <div data-section="s-in-progress" class="task-list-container" data-connect="sorting">
                                <div class="connect-sorting">
                                    ...
                                    <div class="connect-sorting-content ui-sortable" data-sortable="true">
                                        ...
                                        <div data-draggable="true" class="card task-text-progress ui-sortable-handle">
                                            <div class="card-body">
                            ...
                            <div data-section="s-approved" class="task-list-container" data-connect="sorting">
                                ...
                                <div class="connect-sorting">
                                    <div class="task-container-header">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right left" aria-labelledby="dropdownMenuLink-3" style="">
                                                <a class="dropdown-item list-edit" href="javascript:void(0);">Edit</a>
                                                <a class="dropdown-item list-delete" href="javascript:void(0);">Delete</a>
                                                <a class="dropdown-item list-clear-all" href="javascript:void(0);">Clear All</a>
                                            </div>
